...
ANT_METRA_SF_TD = [
    'anonymous-il-scale/metra-with-avalon/exp/ant_metra_sf_td_with_goal_metrics/sd000_s_21309131.0.1721099386_ant_metra_sf/progress_eval.csv',
    'anonymous-il-scale/metra-with-avalon/exp/ant_metra_sf_td_with_goal_metrics/sd001_s_21309132.0.1721099386_ant_metra_sf/progress_eval.csv',
]

ANT_METRA_L2_GAUSSIAN_Z_NO_DONE = [
    'anonymous-il-scale/metra-with-avalon/exp/ant_with_goal_metrics_l2_penalty_with_fixed_lambda_0.5_gaussian_z_no_done/sd001_s_21377685.0.1721417380_ant_metra/progress_eval.csv',
    'anonymous-il-scale/metra-with-avalon/exp/ant_with_goal_metrics_l2_penalty_with_fixed_lambda_0.5_gaussian_z_no_done/sd001_s_21377686.0.1721417380_ant_metra/progress_eval.csv',
]
...
ANT_METRA_L2_GAUSSIAN_Z = [
    'anonymous-il-scale/metra-with-avalon/exp/ant_with_goal_metrics_l2_penalty_with_fixed_lambda_0.5_gaussian_z/sd001_s_21404264.0.1721574158_ant_metra/progress_eval.csv',
    'anonymous-il-scale/metra-with-avalon/exp/ant_with_goal_metrics_l2_penalty_with_fixed_lambda_0.5_gaussian_z/sd001_s_21404265.0.1721574158_ant_metra/progress_eval.csv',
]
...
ANT_METRA_SUM_SF_TD_INFONCE_RELABEL_ACTOR_NO_DONE = [
    'anonymous-il-scale/metra-with-avalon/exp/ant_metra_sum_sf_td_infonce_relabel_actor_no_done_with_goal_metrics/sd000_s_21498127.0.1722113789_ant_metra_sf/progress_eval.csv',
    'anonymous-il-scale/metra-with-avalon/exp/ant_metra_sum_sf_td_infonce_relabel_actor_no_done_with_goal_metrics/sd001_s_21498128.0.1722113789_ant_metra_sf/progress_eval.csv',
]

ANT_METRA_SUM_SF_TD_INFONCE_RELABEL_ACTOR_FP_NO_DONE = [
    'anonymous-il-scale/metra-with-avalon/exp/ant_metra_sum_sf_td_infonce_relabel_actor_fp_no_done_with_goal_metrics/sd000_s_21500576.0.1722125588_ant_metra_sf/progress_eval.csv',
    'anonymous-il-scale/metra-with-avalon/exp/ant_metra_sum_sf_td_infonce_relabel_actor_fp_no_done_with_goal_metrics/sd001_s_21500577.0.1722125588_ant_metra_sf/progress_eval.csv',
]
...
CHEETAH_METRA = [
    'anonymous-il-scale/metra-with-avalon/exp/cheetah_metra_with_goal_metrics/sd000_s_21308977.0.1721099386_half_cheetah_metra/progress_eval.csv',
    'anonymous-il-scale/metra-with-avalon/exp/cheetah_metra_with_goal_metrics/sd001_s_21308978.0.1721099386_half_cheetah_metra/progress_eval.csv',
]
...
CHEETAH_METRA_SF_TD = [
    'anonymous-il-scale/metra-with-avalon/exp/cheetah_metra_sf_td_with_goal_metrics/sd000_s_21309129.0.1721099386_half_cheetah_metra_sf/progress_eval.csv',
    'anonymous-il-scale/metra-with-avalon/exp/cheetah_metra_sf_td_with_goal_metrics/sd001_s_21309130.0.1721099386_half_cheetah_metra_sf/progress_eval.csv',
]
...
QUADRUPED_METRA = [
    'anonymous-il-scale/metra-with-avalon/exp/quadruped_metra_with_goal_metrics_goal_range_15/sd000_s_21311337.0.1721099400_dmc_quadruped_metra/progress_eval.csv',
    'anonymous-il-scale/metra-with-avalon/exp/quadruped_metra_with_goal_metrics_goal_range_15/sd001_s_21311338.0.1721099400_dmc_quadruped_metra/progress_eval.csv',
]
...
QUADRUPED_DIAYN_NO_DONE = [
    'anonymous-il-scale/metra-with-avalon/exp/quadruped_diayn_no_done/sd000_s_21715986.0.1723560923_dmc_quadruped_metra/progress_eval.csv',
    'anonymous-il-scale/metra-with-avalon/exp/quadruped_diayn_no_done/sd001_s_21715987.0.1723560923_dmc_quadruped_metra/progress_eval.csv',
]
...
HUMANOID_DIAYN_NO_DONE = [
    'anonymous-il-scale/metra-with-avalon/exp/humanoid_diayn_no_done/sd000_s_21716089.0.1723561238_dmc_humanoid_metra/progress_eval.csv',
    'anonymous-il-scale/metra-with-avalon/exp/humanoid_diayn_no_done/sd001_s_21716090.0.1723561238_dmc_humanoid_metra/progress_eval.csv',
]
...
KITCHEN_METRA = [
    'anonymous-il-scale/metra-with-avalon/exp/kitchen_metra_with_goal_metrics/sd000_s_21311499.0.1721099608_kitchen_metra/progress_eval.csv',
    'anonymous-il-scale/metra-with-avalon/exp/kitchen_metra_with_goal_metrics/sd001_s_21311500.0.1721099608_kitchen_metra/progress_eval.csv',
]
...
KITCHEN_METRA_SF_TD = [
    'anonymous-il-scale/metra-with-avalon/exp/kitchen_metra_sf_td_with_goal_metrics/sd000_s_21313541.0.1721099719_kitchen_metra_sf/progress_eval.csv',
    'anonymous-il-scale/metra-with-avalon/exp/kitchen_metra_sf_td_with_goal_metrics/sd001_s_21313542.0.1721099719_kitchen_metra_sf/progress_eval.csv',
]
...
def plot(experiments, titles, yv_labels, ylabel: str = 'Success Rate'):
    ...
    for ax, experiment, title, yv_label in zip(axes, experiments, titles, yv_labels):
        for label, filepaths in experiment.items():
            if 'Kitchen' in title and label == 'Metra sum (no done)':
                mean_values, std_dev, total_env_steps = compute_mean_and_std(filepaths, f'EvalOp/KitchenSingleGoalOverall')
            else:
                suffix = ''
                if 'Cheetah' in title and label == 'Metra sum (no done)':
                    suffix = 'Adaptive'
...
plot(all_experiments, titles, ['EvalOp/HitSuccess3', 'EvalOp/HitSuccess3', 'EvalOp/HitSuccess3', 'EvalOp/HitSuccess3', 'EvalOp/KitchenGoalOverall'], ylabel='Hit Success Rate')
plot(all_experiments, titles, ['EvalOp/AtSuccess3', 'EvalOp/AtSuccess3', 'EvalOp/AtSuccess3', 'EvalOp/AtSuccess3', 'EvalOp/KitchenGoalOverall'], ylabel='Stay Success Rate')
plot(all_experiments, titles, ['EvalOp/EndSuccess3', 'EvalOp/EndSuccess3', 'EvalOp/EndSuccess3', 'EvalOp/EndSuccess3', 'EvalOp/KitchenGoalOverall'], ylabel='End Success Rate')

plot(all_experiments, titles, ['EvalOp/HitSuccess1', 'EvalOp/HitSuccess1', 'EvalOp/HitSuccess1', 'EvalOp/HitSuccess1', 'EvalOp/KitchenGoalOverall'], ylabel='Hit Success Rate')
plot(all_experiments, titles, ['EvalOp/AtSuccess1', 'EvalOp/AtSuccess1', 'EvalOp/AtSuccess1', 'EvalOp/AtSuccess1', 'EvalOp/KitchenGoalOverall'], ylabel='Stay Success Rate')
plot(all_experiments, titles, ['EvalOp/EndSuccess1', 'EvalOp/EndSuccess1', 'EvalOp/EndSuccess1', 'EvalOp/EndSuccess1', 'EvalOp/KitchenGoalOverall'], ylabel='End Success Rate')
